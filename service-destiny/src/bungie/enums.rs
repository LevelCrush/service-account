...
impl std::fmt::Display for DestinyActivityModeType {
    fn fmt(&self, f: &mut Formatter<'_>) -> fmt::Result {
        match *self {
            DestinyActivityModeType::None => write!(f, "None"),
            DestinyActivityModeType::Story => write!(f, "Story"),
            DestinyActivityModeType::Strike => write!(f, "Strike"),
            DestinyActivityModeType::Raid => write!(f, "Raid"),
            DestinyActivityModeType::AllPvP => write!(f, "AllPvP"),
            DestinyActivityModeType::Patrol => write!(f, "Patrol"),
            DestinyActivityModeType::AllPvE => write!(f, "AllPvE"),
            DestinyActivityModeType::Reserved9 => write!(f, "Reserved9"),
            DestinyActivityModeType::Control => write!(f, "Control"),
            DestinyActivityModeType::Reserved11 => write!(f, "Reserved11"),
            DestinyActivityModeType::Clash => write!(f, "Clash"),
            DestinyActivityModeType::Reserved13 => write!(f, "Reserved13"),
            DestinyActivityModeType::CrimsonDoubles => write!(f, "CrimsonDoubles"),
            DestinyActivityModeType::Nightfall => write!(f, "Nightfall"),
            DestinyActivityModeType::HeroicNightfall => write!(f, "HeroicNightfall"),
            DestinyActivityModeType::AllStrikes => write!(f, "AllStrikes"),
            DestinyActivityModeType::IronBanner => write!(f, "IronBanner"),
            DestinyActivityModeType::Reserved20 => write!(f, "Reserved20"),
            DestinyActivityModeType::Reserved21 => write!(f, "Reserved21"),
            DestinyActivityModeType::Reserved22 => write!(f, "Reserved22"),
            DestinyActivityModeType::Reserved24 => write!(f, "Reserved24"),
            DestinyActivityModeType::AllMayhem => write!(f, "AllMayhem"),
            DestinyActivityModeType::Reserved26 => write!(f, "Reserved26"),
            DestinyActivityModeType::Reserved27 => write!(f, "Reserved27"),
            DestinyActivityModeType::Reserved28 => write!(f, "Reserved28"),
            DestinyActivityModeType::Reserved29 => write!(f, "Reserved29"),
            DestinyActivityModeType::Reserved30 => write!(f, "Reserved30"),
            DestinyActivityModeType::Supremacy => write!(f, "Supremacy"),
            DestinyActivityModeType::PrivateMatchesAll => write!(f, "PrivateMatchesAll"),
            DestinyActivityModeType::Survival => write!(f, "Survival"),
            DestinyActivityModeType::Countdown => write!(f, "Countdown"),
            DestinyActivityModeType::TrialsOfTheNine => write!(f, "TrialsOfTheNine"),
            DestinyActivityModeType::Social => write!(f, "Social"),
            DestinyActivityModeType::TrialsCountdown => write!(f, "TrialsCountdown"),
            DestinyActivityModeType::TrialsSurvival => write!(f, "TrialsSurvival"),
            DestinyActivityModeType::IronBannerControl => write!(f, "IronBannerControl"),
            DestinyActivityModeType::IronBannerClash => write!(f, "IronBannerClash"),
            DestinyActivityModeType::IronBannerSupremacy => write!(f, "IronBannerSupremacy"),
            DestinyActivityModeType::ScoredNightfall => write!(f, "ScoredNightfall"),
            DestinyActivityModeType::ScoredHeroicNightfall => write!(f, "ScoredHeroicNightfall"),
            DestinyActivityModeType::Rumble => write!(f, "Rumble"),
            DestinyActivityModeType::AllDoubles => write!(f, "AllDoubles"),
            DestinyActivityModeType::Doubles => write!(f, "Doubles"),
            DestinyActivityModeType::PrivateMatchesClash => write!(f, "PrivateMatchesClash"),
            DestinyActivityModeType::PrivateMatchesControl => write!(f, "PrivateMatchesControl"),
            DestinyActivityModeType::PrivateMatchesSupremacy => write!(f, "PrivateMatchesSupremacy"),
            DestinyActivityModeType::PrivateMatchesCountdown => write!(f, "PrivateMatchesCountdown"),
            DestinyActivityModeType::PrivateMatchesSurvival => write!(f, "PrivateMatchesSurvival"),
            DestinyActivityModeType::PrivateMatchesMayhem => write!(f, "PrivateMatchesMayhem"),
            DestinyActivityModeType::PrivateMatchesRumble => write!(f, "PrivateMatchesRumble"),
            DestinyActivityModeType::HeroicAdventure => write!(f, "HeroicAdventure"),
            DestinyActivityModeType::Showdown => write!(f, "Showdown"),
            DestinyActivityModeType::Lockdown => write!(f, "Lockdown"),
            DestinyActivityModeType::Scorched => write!(f, "Scorched"),
            DestinyActivityModeType::ScorchedTeam => write!(f, "ScorchedTeam"),
            DestinyActivityModeType::Gambit => write!(f, "Gambit"),
            DestinyActivityModeType::AllPvECompetitive => write!(f, "AllPvECompetitive"),
            DestinyActivityModeType::Breakthrough => write!(f, "Breakthrough"),
            DestinyActivityModeType::BlackArmoryRun => write!(f, "BlackArmoryRun"),
            DestinyActivityModeType::Salvage => write!(f, "Salvage"),
            DestinyActivityModeType::IronBannerSalvage => write!(f, "IronBannerSalvage"),
            DestinyActivityModeType::PvPCompetitive => write!(f, "PvPCompetitive"),
            DestinyActivityModeType::PvPQuickplay => write!(f, "PvPQuickplay"),
            DestinyActivityModeType::ClashQuickplay => write!(f, "ClashQuickplay"),
            DestinyActivityModeType::ClashCompetitive => write!(f, "ClashCompetitive"),
            DestinyActivityModeType::ControlQuickplay => write!(f, "ControlQuickplay"),
            DestinyActivityModeType::ControlCompetitive => write!(f, "ControlCompetitive"),
            DestinyActivityModeType::GambitPrime => write!(f, "GambitPrime"),
            DestinyActivityModeType::Reckoning => write!(f, "Reckoning"),
            DestinyActivityModeType::Menagerie => write!(f, "Menagerie"),
            DestinyActivityModeType::VexOffensive => write!(f, "VexOffensive"),
            DestinyActivityModeType::NightmareHunt => write!(f, "NightmareHunt"),
            DestinyActivityModeType::Elimination => write!(f, "Elimination"),
            DestinyActivityModeType::Momentum => write!(f, "Momentum"),
            DestinyActivityModeType::Dungeon => write!(f, "Dungeon"),
            DestinyActivityModeType::Sundial => write!(f, "Sundial"),
            DestinyActivityModeType::TrialsOfOsiris => write!(f, "TrialsOfOsiris"),
            DestinyActivityModeType::Dares => write!(f, "Dares"),
            DestinyActivityModeType::Offensive => write!(f, "Offensive"),
            DestinyActivityModeType::LostSector => write!(f, "LostSector"),
            DestinyActivityModeType::Rift => write!(f, "Rift"),
            DestinyActivityModeType::ZoneControl => write!(f, "ZoneControl"),
            DestinyActivityModeType::IronBannerRift => write!(f, "IronBannerRift"),
            DestinyActivityModeType::IronBannerZoneControl => write!(f, "IronBannerZoneControl"),
            DestinyActivityModeType::Unknown => write!(f, "Unknown"),
        }
    }
}
